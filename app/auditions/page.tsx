  ...
  return (
    <>
      <PageHero
        ...
        subtitle="We are primarily a youth theatre — welcoming performers up to age 19. No experience necessary. If you want to perform, we want to meet you."
      ...
      <section style={{ padding: '0 48px 120px' }}>
        <div style={{ maxWidth: '800px', margin: '0 auto' }}>
          ...
          {[
            ...
            { q: 'What age ranges do you cast?', a: 'We are a youth theatre — our productions are primarily cast with performers up to age 19. We also produce one family show each season that opens casting to the broader community.' },

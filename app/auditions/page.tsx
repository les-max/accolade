  ...
  return (
    <>
      <PageHero
        ...
        title="Auditions"
        titleItalic="Open to Everyone"
        subtitle="No experience necessary. We cast community members of all ages and backgrounds. If you want to perform, we want to meet you."
      ...
      <section style={{ padding: '0 48px 120px' }}>
        <div style={{ maxWidth: '800px', margin: '0 auto' }}>
          ...
          {[
            ...
            { q: 'What age ranges do you cast?', a: 'It depends on the show. We produce productions for all ages — family shows, adult productions, youth camps, and everything in between.' },
